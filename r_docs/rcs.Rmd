...
All of the following plots use the HLI score of 5 as the reference. Hazard ratios (HRs) are present on the vertical axes and HLI scores are present on the horizontal axesShaded regions represent 95% confidence intervals.\
\
\
