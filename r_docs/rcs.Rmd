...
<span style="color:gray">Figure 1. Non-linear association of HLI score and risk for common cancers. Shaded region visualises 95% CI. Restricted cubic splines fitted with three knots for each cancer model, and five knots for the lung cancer model, positioned at boundaries and percentiles. </span>
...
png("C:/Users/sch044/OneDrive - UiT Office 365/R/Paper1_new/output/3knot_plots.png")
rcs3Knots
dev.off()
...
knitr::kable(as.data.frame(AIC), digits = 2,
             caption = "Table 1. AIC values for linear and flexible models (3-5 RCS knots) among common cancers")
```
...
lungSplineOptions <- ggarrange(plotLung4,
                               plotLung3,
                               plotLung,
                               ncol=2, nrow=2)
