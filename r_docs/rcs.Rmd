...
subtitle: "Demonstrating model fit of associations between the healthy lifestyle index (HLI) score modelled as a nonlinear term and incidences of common cancer types in the Norwegian Women and Cancer Study"
...
knitr::kable(as.data.frame(AIC), digits = 2,
             caption = "AIC values for linear and nonlinear models (3-5 RCS knots) among common cancer types")
```
