...
subtitle: "Sensitivity analysis of nonlinear associations by exclusion of single lifestyle factors from the healthy lifestyle index (HLI) score"

#author: "Sairah L.F. Chen"
#date: "14 12 2020"
output: pdf_document

# TODO Could not get these models to have their reference to be set to HLI=5 like in the main analysis. Will work on it. 
...
This additional file displays results from sensitivity analyses conducted on associations with the HLI modelled as a nonlinear term using restricted cubic splines (RCS) with three knots. Single lifestyle factors were excluded from the HLI score, creating five reduced models. Thus, five estimated associations were obtained for each cancer outcome. Here, we visualise these results in plots. (COMMENT: reference HLI still needs to be set to 5 in plots)
...
Figure 1. Postmenopausal breast cancer incidence and its association with HLI score excluding single lifestyle factors. Models are adjusted for education, height, age at menarche, ever use of oral contraceptives, parity, breastfeeding, using of hormone replacement therapy, and history of breast cacner n a first-degree relative. The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
...
Figure 2. Colorectal cancer incidence and its association with HLI score excluding single lifestyle factors. Models are adjusted for education and height. The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
...
Figure 3. Lung cancer incidence and its association with HLI score excluding single lifestyle factors. Models are adjusted for education and height. The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
...
Figure 4. Postmenopausal endometrial cancer incidence and its association with HLI score excluding single lifestyle factors. Models are adjusted for education, height, age at menarche, ever use of oral contraceptive, parity, breastfeeding, use of hormone replacement therapy. The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
...
Figure 5. Postmenopausal ovarian cancer incidence and its association with HLI score excluding single lifestyle factors. Models are adjusted for education, height, age at menarche, ever use of oral contraceptive, parity, breastfeeding, use of hormone replacement therapy.  The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
...
Figure 6. Pancreatic cancer incidence and its association with HLI score excluding single lifestyle factors. Models are adjusted for education and height. The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
...
Figure 7. Kidney cancer incidence and its association with HLI score excluding single lifestyle components. Models are adjusted for education and height. The shaded regions represent the 95% confidence intervals and the reference HLI score is set to 5. 
